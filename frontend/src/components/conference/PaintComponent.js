...
export default class PaintComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            messageList: [],
    ...
    componentDidMount() {
        this.props.user.getStreamManager().stream.session.on('signal:paint', (event) => {
    ...
    sendMessage() {
        console.log("데이터 전송", this.state.message);
